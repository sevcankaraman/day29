...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        ilkHarfVec(meyve);
        System.out.println(" \n  *******");
        elemanlarinBasVeSonYildiz(meyve);
        System.out.println(" \n  *******");
        System.out.println(karSayBuyKucSirKarSayEnBuyIlk3El(meyve));
    ...
    public static void ilkHarfVec(List<String>meyve){
        meyve.stream().
    ...
    public static void elemanlarinBasVeSonYildiz(List<String>meyve){
        meyve.stream().
                map(t->"*"+t+"*").
                forEach(Utils::yazdir);
    }
    ...
    public static List<String> karSayBuyKucSirKarSayEnBuyIlk3El(List<String>meyve){
        ...
        return sonuc;
                ...
                /*
                   java akıştan gelen elemanlar ya String değilse diye
                   oluyor o yüzden toString methodu ekliyoruz.
                */
