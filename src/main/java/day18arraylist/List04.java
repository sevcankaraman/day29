...
public class List04 {
    public static void main(String[] args) {
        ...
        females.add("Ajda");
        females.add("Emel");
        //"names.containsAll(females)" "names" listinde "females" listindeki "tum elemanlarin" 
        ...
        System.out.println("sublist = " + sublist);//sublist = [Cuneyt, Mahsun, Muslum]
        ...
        System.out.println(names.hashCode());//2041509// java içindir bu method bız pek kullanmayız.
