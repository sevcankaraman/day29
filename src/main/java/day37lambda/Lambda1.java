...
// O yuzden bitis degeri bize verilenden 1 ust deger olması gerekir.
        ...
        // return type int oldugu icin buraya return -1 yazmazsak hata verir
        ...
        System.out.println(ikiTmSy(15,14));
    ...
    public static int ikiTmSy(int a,int b){
    ...
    //6) Size verilen iki tamsayı arasındakı tum tamsayıları rakamları toplamını veren kodu yazınız
