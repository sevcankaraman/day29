...
public abstract class Courses {
    ...
    /*
        1)Bazen method body'sini yazmak gerekmez, bu durumlarda body'siz method olusturmak gerekir.
          Body'si olmayan method'lara "abstract(SOYUT) method" lar denir.
    ...
    */
    ...
    //"abstract method"lar "private" olamazlar, cunku Child Class'lar abstract method'lari kullanirlar, private
    // yapinca kullanima kapali olur.

    //Bu celiskidir, bu yuzden Java abstract method'larin "private" olmasina musaade etmez.

    //"abstract method" lar "static" olamazlar, cunku static method'lar override edilemez, halbuki
    // abstract method'lar override edilmek icin olusturulmustur.
