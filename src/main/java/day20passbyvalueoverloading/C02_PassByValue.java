 ...
 */
    public static void main(String[] args) {
       ...
       // System.out.println("unlem eklendıktensonra kutlama = " + kutlama);
        kutlama= kutlamaUnlemIle(kutlama);
        System.out.println("methodtan sonra atama yapılınca main içinde kutlama = " + kutlama);
    }//main

    private static String kutlamaUnlemIle(String kutlama) {
        String unlemliKutlama=kutlama+"!";

        System.out.println("method içinde kutlama = " + kutlama);
